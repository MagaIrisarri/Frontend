...
export const createBulkParkingSpaces = (parkingId: string, data: { vehicleType: string; count: number }) =>
  api.put(`/api/parkings/${parkingId}/spaces`, data).then(res => res.data);
